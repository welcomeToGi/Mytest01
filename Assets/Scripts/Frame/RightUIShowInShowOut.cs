...
public class RightUIShowInShowOut : MonoBehaviour
{
    public GameObject RightUI;
    public GameObject RightUIShowButton;
    ...
    {
        RightUI.transform.DOLocalMove(new Vector3(1118, -19, 0), 0.5f);
    ...
    {
        RightUI.transform.DOLocalMove(new Vector3(800, -19, 0), 0.5f);
